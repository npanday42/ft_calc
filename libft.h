...
/*                                                   +#+                      */
/*   Created: 2019/01/09 18:10:17 by npanday        #+#    #+#                */
/*   Updated: 2019/02/06 17:47:53 by npanday       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
char					*ft_itoa(int n);
char					*ft_itoab(int n, unsigned int b);
...
int						ft_atoib(const char *str, unsigned int b);
...
t_ulong					ft_abs(long n);
t_ulong					ft_factorial(int n);
